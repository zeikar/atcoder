...
- `sitemap.xml` and `rss.xml` are built next to the home page, e.g. `https://<owner>.github.io/<repo>/sitemap.xml`. The feed carries only the newest 20 posts, in full, with their code unhighlighted.
